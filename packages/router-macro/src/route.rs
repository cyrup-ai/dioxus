                    ...
                    .find(|attr| attr.path().is_ident("child"))
                {
                    ...
                    match &variant.fields {
                            ...
                            match child_field {
                                ...
                                None => {
                                    return Err(syn::Error::new_spanned(
                                        variant.clone(),
                                        "Routable variants with a #[child(..)] attribute must \
                                         have a field named \"child\" or a field with a #[child] \
                                         attribute",
                                    ));
                                }
                            }
                        ...
                        _ => {
                            return Err(syn::Error::new_spanned(
                                variant.clone(),
                                "Routable variants with a #[child(..)] attribute must have named \
                                 fields",
                            ));
                        }
                    }
                    ...
                    return Err(syn::Error::new_spanned(
                        variant.clone(),
                        "Routable variants must either have a #[route(..)] attribute or a \
                         #[child(..)] attribute",
                    ));
                }
            }
