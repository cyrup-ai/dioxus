...
use crate::{
    Element, Runtime, VNode, any_props::BoxedAnyProps, nodes::AsVNode,
...
impl ScopeState {
    ...
    pub fn root_node(&self) -> &VNode {
        self.try_root_node().expect(
            "The tree has not been built yet. Make sure to call rebuild on the tree before \
             accessing its nodes.",
        )
    }
