...
use crate::{
    NodeId,
    events::{BlitzKeyboardData, NativeClickData, NativeConverter, NativeFormData},
...
impl EventHandler for DioxusEventHandler<'_> {
    fn handle_event(
        ...
        let event_data = match &event.data {
            ...
            // Change events could contain form data but as unit variant, use empty form data
            DomEventData::Change => Some(wrap_event_data(NativeFormData {
                value: String::new(),
                values: HashMap::new(),
            })),

            // Submit events carry form data from the submitted form
            DomEventData::Submit => Some(wrap_event_data(NativeFormData {
                value: String::new(),
                values: HashMap::new(),
            })),

            // Focus and Blur events don't carry additional data
            DomEventData::Focus | DomEventData::Blur => None,
