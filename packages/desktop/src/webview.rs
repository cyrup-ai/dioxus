...
use crate::{
    Config, DesktopContext, DesktopService, PendingDesktopContext, WeakDesktopContext,
    ...
    file_upload::{DesktopFileDragEvent, NativeFileEngine, NativeFileHover},
    ipc::UserWindowEvent,
    menubar::DioxusMenu,
    protocol,
    waker::tao_waker,
...
impl WebviewInstance {
    pub(crate) fn new(
        ...
        #[allow(deprecated)]
        {
            use cocoa::{appkit::NSWindowCollectionBehavior, base::id};
