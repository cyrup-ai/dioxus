    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            EvalError::Communication(_) => write!(
                f,
                "EvalError::Communication - there was an error trying to communicate with between \
                 javascript and rust"
            ),
            EvalError::Serialization(_) => write!(
                f,
                "EvalError::Serialization - there was an error trying to serialize or deserialize \
