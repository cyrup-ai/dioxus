...
fn to_string_works() {
    ...
    assert_eq!(
        out,
        "<div class=\"asdasdasd asdasdasd\" id=\"id-123\">Hello world 1 --&#62;123&#60;-- Hello \
         world 2<div>nest 1</div><div></div><div>nest 2</div>&#60;/diiiiiiiiv&#62;<div>finalize \
         0</div><div>finalize 1</div><div>finalize 2</div><div>finalize 3</div><div>finalize \
         4</div></div>"
    );
}
