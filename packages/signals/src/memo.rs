...
use crate::{
    CopyValue, GlobalMemo, ReadableExt, ReadableRef, Signal, WritableExt, read::Readable,
    read_impls, write::Writable,
};
...
where T: Clone + IntoAttributeValue + PartialEq
{
...
where T: Clone + IntoDynNode + PartialEq
{
