...
fn don_t_escape_dynamic_scripts() {
    ...
    assert_eq!(
        dioxus_ssr::pre_render(&dom),
        "<script data-node-hydration=\"0\"><!--node-id1-->console.log('hello \
         world');<!--#--></script>"
    );
}
...
fn don_t_escape_dynamic_styles() {
    ...
    assert_eq!(
        dioxus_ssr::pre_render(&dom),
        "<style data-node-hydration=\"0\"><!--node-id1-->body { font-family: \"sans-serif\"; \
         }<!--#--></style>"
    );
}
...
fn escape_static_component_fragment_div() {
    ...
    assert_eq!(
        dioxus_ssr::pre_render(&dom),
        "<div data-node-hydration=\"0\"><!--node-id1-->body { font-family: &#34;sans-serif&#34;; \
         }<!--#--></div>"
    );
}
