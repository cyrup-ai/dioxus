...
{}"#,
    ...
    for (idx, chunk) in chunks.iter().enumerate() {
        ...
        writeln!(
            ...
            "export const __wasm_split_load_chunk_{idx} = \
             makeLoad(\"/harness/split/chunk_{idx}_{module}.wasm\", [], fusedImports, initSync);",
    ...
    for (idx, module) in modules.iter().enumerate() {
        ...
        writeln!(
            glue,
            "export const __wasm_split_load_{module}_{hash_id}_{cname} = \
             makeLoad(\"/harness/split/module_{idx}_{cname}.wasm\", [{deps}], fusedImports, \
             initSync);",
