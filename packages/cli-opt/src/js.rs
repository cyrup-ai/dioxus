...
use swc_common::{
    FileName, FilePathMapping, GLOBALS, Globals, Mark, SourceMap, Span,
...
use swc_ecma_loader::{TargetEnv, resolvers::node::NodeModulesResolver};
use swc_ecma_minifier::option::{ExtraOptions, MinifyOptions};
use swc_ecma_parser::{Parser, Syntax, lexer::Lexer, parse_file_as_module};
