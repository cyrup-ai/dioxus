...
use crate::Color;
use anyrender_vello::{CustomPaintCtx, CustomPaintSource, TextureHandle, wgpu_context::DeviceHandle};
...
impl CustomPaintSource for DemoPaintSource {
    fn resume(&mut self, instance: &wgpu::Instance, device_handle: &DeviceHandle) {
        // TODO: work out what to do about width/height
        let active_state = ActiveDemoRenderer::new(&device_handle.device, &device_handle.queue);
