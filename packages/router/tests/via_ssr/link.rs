...
fn with_child_route() {
    ...
    assert_eq!(
        prepare_at::<Route>("/"),
        "<h1>App</h1><a href=\"/test\">Parent Link</a><a \
         href=\"/child/this-is-a-child-route\">Child Link</a>"
    );

    assert_eq!(
        prepare_at::<Route>("/child"),
        "<h1>App</h1><a href=\"/test\">Parent Link</a><a \
         href=\"/child/this-is-a-child-route\">Child Link 1</a><a \
         href=\"/child/this-is-a-child-route\">Child Link 2</a>"
    );
}
