...
use id_arena::Id;
use walrus::{
    ConstExpr, Data, DataId, DataKind, Element, ElementId, ElementItems, ElementKind, ExportId,
    ExportItem, Function, FunctionId, FunctionKind, Global, GlobalId, GlobalKind, Memory, MemoryId,
    Module, RefType, Table, TableId, Type, TypeId, ir::*,
};
